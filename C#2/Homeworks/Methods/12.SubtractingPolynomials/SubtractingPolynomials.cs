...
class SubtractingPolynomials
{
    static void Main()
    {
        ...
        PrintArray(SubtractionOfPolinomials(firstArray, secondArray, result));
        Console.WriteLine();
        Console.Write("The multyplication   ");
        PrintArray(MyltiplicationOfPolinomials(firstArray, secondArray));

    }

    static decimal[] MyltiplicationOfPolinomials(decimal[] firstArray, decimal[] secondArray)
    {
    ...
    static decimal[] SubtractionOfPolinomials(decimal[] firstArray, decimal[] secondArray, decimal[] result)
    {
