...
class MobilePhoneMain
{
    static void Main()
    {
        ...
        // problem 7
        testGsm.CreateSomeGSM();

        Console.WriteLine();

        // problem 12
        GSMCallHistoryTest testHistory = new GSMCallHistoryTest();
        testHistory.CreateCallHistory();
        testHistory.PrintCallHistory();
        Console.WriteLine();
        testHistory.TotalPriceOfCalls();
        testHistory.RemoveLongest();
...
Display the information about the static property IPhone4S.
 ...
 08.Create a class Call to hold a call performed through a GSM.It should contain date, time, dialled phone number and duration (in seconds).
